...
def abrirventana():
    ...
    def abrir_generales():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Hospitales%20generales.html", new=2, autoraise=True)
    def abrir_privados():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Hospitales%20privados.html", new=2, autoraise=True)
    def abrir_centros_de_salud():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Hospitales%20centros%20de%20salud.html", new=2, autoraise=True)
    def abrir_en_otros_distritos():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Hospitales%20en%20otros%20distritos.html", new=2, autoraise=True)
    ...
    def abrir_BN_BBVA_BCP():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Bancos%20BBVA%20BCP%20BN.html", new=2, autoraise=True)
    def abrir_otros_bancos():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Bancos%20otros%20bancos.html", new=2, autoraise=True)
    def abrir_en_otros_distritos2():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Bancos%20en%20otros%20distritos.html", new=2, autoraise=True)
    ...
    def abrir_mas_cercanos():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Gasolinerias%20cerca.html", new=2, autoraise=True)
    def abrir_en_otros_distritos3():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Gasolinerias%20en%20otros%20distritos.html", new=2, autoraise=True)
    ...
    def abrir_1a3():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Hoteles%201-3.html", new=2, autoraise=True)
    def abrir_4a5():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Hoteles%204-5.html", new=2, autoraise=True)
    def abrir_mejores_valoraciones():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Hoteles%20mejores%20valoraciones.html", new=2, autoraise=True)
    def abrir_en_otros_distritos4():
        webbrowser.open("file:///F:/Proyecto_Mapa_ubicaciones/Hoteles%20en%20otros%20distritos.html", new=2, autoraise=True)
...
#imagen_de_logo=PhotoImage(file="imagenn.gif")
#lbldelaimagen=Label(ventana1,image=imagen_de_logo).place(x=500,y=100)
...
#Parte_pa_entrar=Label(text="Aqui podras buscar lo que quieras",font=("Times New Roman",18),fg="black",bg="white").place(x=470,y=10)
